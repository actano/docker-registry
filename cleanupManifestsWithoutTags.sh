...
REGISTRY_DIR=/home/vagrant/container-registry/data/docker/registry/v2/repositories
REGISTRY_URL=https://docker.actano.de
USERNAME=
PASSWORD=
...
for manifest in ${manifests_without_tags}; do
    ...
    curl -u ${USERNAME}:${PASSWORD} -X DELETE ${REGISTRY_URL}/v2/${repo}/manifests/sha256:${manifest}
